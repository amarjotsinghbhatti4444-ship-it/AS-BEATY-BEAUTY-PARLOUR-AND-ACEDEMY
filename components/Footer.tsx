...
export default function Footer() {
  return (
    <footer className="bg-dark-primary text-gray-400 py-16 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 lg:col-span-1">
            <Link href="#home" className="flex flex-col items-start mb-6">
              ...
              <span className="text-[10px] text-gray-500 tracking-[0.2em] uppercase">Salon & Academy</span>
            </Link>
            <p className="text-sm leading-relaxed mb-6">
              Transforming your beauty and building successful careers with top-tier professional salon services and certified training courses.
            </p>
          </div>
          ...
          {/* Services */}
          <div>
            <h4 className="text-white font-serif text-lg mb-6 tracking-wide">Our Services</h4>
            <ul className="space-y-3">
          ...
          {/* Courses */}
          <div>
            <h4 className="text-white font-serif text-lg mb-6 tracking-wide">Academy Courses</h4>
            <ul className="space-y-3">
        ...
        <div className="border-t border-white/10 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs tracking-widest uppercase">
            &copy; {new Date().getFullYear()} AS Beauty Salon & Academy. All Rights Reserved.
          </p>
          <div className="flex space-x-4">
            <a href="#" className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center hover:bg-gold hover:border-gold hover:text-white transition-colors">
